...
//        .isEqualTo(1);
    ...
    Product findedProduct = product.orElseThrow();//값이 없으면 java.util.NoSuchElementException: No value present

//    Assertions.assertThat(product.get().getPname()).isEqualTo("복사기");
//    Assertions.assertThat(product.get().getQuantity()).isEqualTo(10L);
//    Assertions.assertThat(product.get().getPrice()).isEqualTo(10000L);
